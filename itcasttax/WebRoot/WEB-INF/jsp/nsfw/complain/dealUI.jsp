...
<form id="form" name="form" action="${basePath }nsfw/complain_deal.action" method="post" enctype="multipart/form-data">
    ...
    <div class="tableH2">投诉详细信息
       <span style="color:red;">(<s:property value="#complainStateMap[complain.state]"/>)</span>
    </div>
        ...
        <tr>
            ...
            <td>
              ...
              <s:elseif test="%{complain.compMobile.length()>10}">
                <s:property value="%{complain.compMobile.substring(0,4)+'****'+complain.compMobile.substring(8,10)}"/>
              </s:elseif>
            </td>
        </tr>
