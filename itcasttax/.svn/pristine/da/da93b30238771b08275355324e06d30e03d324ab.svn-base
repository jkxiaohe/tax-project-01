                    ...
                    <td width="76" height="100" align="center" valign="middle">
                        <div class="left-tx">
						    ...
						    <s:if test="#session.SYS_USER.headImg!=null && #session.SYS_USER.headImg!=''">
							   <img src="${ctx }/upload/<s:property value='#session.SYS_USER.headImg'/>"  width="70px" height="70px"/>
							</s:if>
							<s:else>
                    ...
                    <td width="60%"><table width="95%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan="2" style=" font-weight:bold; color:#3a7daa;">
                                                                                               姓名：  <s:property value="#session.SYS_USER.name"/>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                                                                                所属部门：<s:property value="#session.SYS_USER.dept"/>
                            </td>
                        </tr>
                    </table>
                    </td>
